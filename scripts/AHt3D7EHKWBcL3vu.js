...
{
  const heatBased = await foundry.applications.api.DialogV2.confirm({window : {title : this.effect.name}, content : "Zastosować ochronę przed atakami opartymi o ciepło?"})
