...
export default class CombatHelpersWFRP {
    ...
    static async checkFearTerror(combat) {
        ...
        if (msg)
            await ChatMessage.create(game.wfrp4e.utility.chatDataSetup(msg, "gmroll", false, {alias: "Strach i Groza"}))
    }
